    ...
    <div class="flex flex-col w-full h-full space-y-8 p-6">
        ...
        <form class="max-w-lg mx-auto w-full" onkeydown="return event.key !== 'Enter'">
            ...
            <div class="relative">
                ...
                <input v-on:input="filterClients" v-model="search_input" type="search" id="default-search" class="block w-full p-4 ps-10 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search clients by company name or contact name..." required />
            </div>
        </form>
